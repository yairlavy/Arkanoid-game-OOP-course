 ...
 * {@code @author} Yair Lavy 322214073
 */
public class Line {
    /**
    ...
    /**
     * Extends the line by a specified length.
     *
     * @param l the length to extend the line
     * @return a new line extended by the specified length
     */
    ...
    /**
     * Returns the closest intersection point to the start of the line with a rectangle.
    ...
    public Point closestIntersectionToStartOfLine(Rectangle rect) {
        ...
        if (rect.getUpperLeft().equals(this.start)
                || rect.getBottomLeft().equals(this.start)
                || rect.getBottomRight().equals(this.start)
                || rect.getUpperRight().equals(this.start)) {
            if (recList.size() >= 3) {
                return this.start;
            }
    ...
    /**
     * Checks if a point is on the line segment defined by this line.
     *
    ...
    public boolean isPointOnLine(Point point, Line other) {
        ...
        return !(point.getX() + epsilon < minX) && !(point.getX() - epsilon > maxX)
                && !(point.getY() + epsilon < minY) && !(point.getY() - epsilon > maxY);
    }
}
