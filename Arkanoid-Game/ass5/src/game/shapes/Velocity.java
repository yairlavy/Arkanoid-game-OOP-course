...
public class Velocity {
    ...
    /**
     * Returns the sign of the speed in the dx component.
     *
     * @return -1 if dx is negative, 1 if dx is positive, 0 if dx is zero
     */
    ...
    /**
     * Returns the sign of the speed in the dy component.
     *
     * @return -1 if dy is negative, 1 if dy is positive, 0 if dy is zero
     */
